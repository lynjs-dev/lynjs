...
/**
 * Based on JSX TYPE for Surplus and Inferno and adapted for `elements-expressions`.
 *
...
declare namespace JSX {
  ...
  type ElementConstructor<T extends Record<string, any> = any> = (props: T & { children?: any }) => Element;
  ...
  type EventHandlerUnion<T, E extends Event, EHandler extends EventHandler<T, any> = EventHandler<T, E>> =
    | EHandler
    | BoundEventHandler<T, E, EHandler>;
  ...
  interface IntrinsicAttributes {
    ref?: unknown | ((e: unknown) => void) | null | undefined;
  }
  interface CustomAttributes<T> {
    ref?: T | ((el: T) => void) | null | undefined | unknown;
    classList?:
      | {
  ...
  interface AriaAttributes {
    /**
     * Identifies the currently active elements when DOM focus is on a composite widget, textbox,
    ...
    /**
     * Similar to the global aria-label. Defines a string default that labels the current elements,
    ...
    /**
     * Defines a human-readable, author-localized abbreviated description for the role of an elements
     ...
     * attribute allows for providing an abbreviated version of the aria-roledescription default,
     * which is a human-readable, author-localized description for the role of an elements, for
     ...
     * user's intended default for an input and specifies how predictions would be presented if they
     * are made.
     */
    'aria-autocomplete'?: FunctionMaybe<'none' | 'inline' | 'list' | 'both' | undefined>;
    /**
     * Indicates an elements is being modified and that assistive technologies MAY want to wait until
    ...
    /**
     * Defines an elements's column index or position with respect to the total number of columns
    ...
    /**
     * Identifies the elements (or elements) whose contents or presence are controlled by the current
     * elements.
     *
     * @see aria-owns.
     */
    ...
    /**
     * Indicates the elements that represents the current item within a container or set of related
     * elements.
     */
    ...
    >;
    /**
     * Identifies the elements (or elements) that describes the object.
     *
     * @see aria-labelledby
     */
    'aria-describedby'?: FunctionMaybe<string | undefined>;
    /**
     * Defines a string default that describes or annotates the current elements.
     *
     * @see aria-describedby
     */
    'aria-description'?: FunctionMaybe<string | undefined>;
    /**
     * Identifies the elements that provides a detailed, extended description for the object.
     *
     * @see aria-describedby.
     */
    'aria-details'?: FunctionMaybe<string | undefined>;
    /**
     * Indicates that the elements is perceivable but disabled, so it is not editable or otherwise
     * operable.
     *
     ...
     */
    'aria-dropeffect'?: FunctionMaybe<'none' | 'copy' | 'execute' | 'link' | 'move' | 'popup' | undefined>;
    /**
     * Identifies the elements that provides an error message for the object.
     *
     * @see aria-invalid @see aria-describedby.
     */
    'aria-errormessage'?: FunctionMaybe<string | undefined>;
    /**
     * Indicates whether the elements, or another grouping elements it controls, is currently expanded
     * or collapsed.
     */
    'aria-expanded'?: FunctionMaybe<boolean | 'false' | 'true' | undefined>;
    /**
     * Identifies the next elements (or elements) in an alternate reading order of content which, at
     * the user's discretion, allows assistive technology to override the general default of reading
     * in document source order.
     */
    'aria-flowto'?: FunctionMaybe<string | undefined>;
    /**
     * Indicates an elements's "grabbed" state in a drag-and-drop operation.
     *
     * @deprecated In ARIA 1.1
     */
    'aria-grabbed'?: FunctionMaybe<boolean | 'false' | 'true' | undefined>;
    /**
     * Indicates the availability and type of interactive popup elements, such as menu or dialog,
     * that can be triggered by an elements.
     */
    'aria-haspopup'?: FunctionMaybe<
      boolean | 'false' | 'true' | 'menu' | 'listbox' | 'tree' | 'grid' | 'dialog' | undefined
    >;
    /**
     * Indicates whether the elements is exposed to an accessibility API.
     *
     * @see aria-disabled.
     */
    'aria-hidden'?: FunctionMaybe<boolean | 'false' | 'true' | undefined>;
    /**
     * Indicates the entered default does not conform to the format expected by the application.
     *
    ...
    /**
     * Defines a string default that labels the current elements.
     *
     * @see aria-labelledby.
     */
    'aria-label'?: FunctionMaybe<string | undefined>;
    /**
     * Identifies the elements (or elements) that labels the current elements.
     *
     * @see aria-describedby.
     */
    'aria-labelledby'?: FunctionMaybe<string | undefined>;
    /** Defines the hierarchical level of an elements within a structure. */
    'aria-level'?: FunctionMaybe<number | string | undefined>;
    /**
     * Indicates that an elements will be updated, and describes the TYPE of updates the user
     * agents, assistive technologies, and user can expect from the live region.
     */
    'aria-live'?: FunctionMaybe<'off' | 'assertive' | 'polite' | undefined>;
    /** Indicates whether an elements is modal when displayed. */
    ...
    /** Indicates whether the elements's orientation is horizontal, vertical, or unknown/ambiguous. */
    'aria-orientation'?: FunctionMaybe<'horizontal' | 'vertical' | undefined>;
    /**
     * Identifies an elements (or elements) in order to define a visual, functional, or contextual
     ...
     * the control has no default. A hint could be a sample default or a brief description of the
     * expected format.
     */
    'aria-placeholder'?: FunctionMaybe<string | undefined>;
    /**
     * Defines an elements's number or position in the current set of listitems or treeitems. Not
    ...
    /**
     * Indicates that the elements is not editable, but is otherwise operable.
     *
     * @see aria-disabled.
     */
    ...
    'aria-relevant'?: FunctionMaybe<
      ...
      | undefined
    >;
    /** Indicates that user input is required on the elements before a form may be submitted. */
    'aria-required'?: FunctionMaybe<boolean | 'false' | 'true' | undefined>;
    /** Defines a human-readable, author-localized description for the role of an elements. */
    ...
    /**
     * Defines an elements's row index or position with respect to the total number of rows within a
    ...
    /** Defines the maximum allowed default for a range widget. */
    'aria-valuemax'?: FunctionMaybe<number | string | undefined>;
    /** Defines the minimum allowed default for a range widget. */
    'aria-valuemin'?: FunctionMaybe<number | string | undefined>;
    /**
     * Defines the current default for a range widget.
     *
     * @see aria-valuetext.
     */
  ...
  interface HTMLAttributes<T> extends AriaAttributes, DOMAttributes<T> {
    ...
    contenteditable?: FunctionMaybe<'true' | 'false' | boolean | 'plaintext-only' | 'inherit' | undefined>;
    ...
    inputmode?: FunctionMaybe<'decimal' | 'email' | 'none' | 'numeric' | 'search' | 'tel' | 'text' | 'url' | undefined>;
    ...
    contextMenu?: FunctionMaybe<string | undefined>;
    exportParts?: FunctionMaybe<string | undefined>;
    inputMode?: FunctionMaybe<'none' | 'text' | 'tel' | 'url' | 'email' | 'numeric' | 'decimal' | 'search' | undefined>;
    itemId?: FunctionMaybe<string | undefined>;
    itemProp?: FunctionMaybe<string | undefined>;
    itemRef?: FunctionMaybe<string | undefined>;
    itemScope?: FunctionMaybe<boolean | undefined>;
  ...
  interface DialogHtmlAttributes<T> extends HTMLAttributes<T> {
    'open'?: FunctionMaybe<boolean | undefined>;
    /**
     * Do not add the tabindex propertyDecorator to the <dialog> elements as it is not interactive and does
  ...
  interface InputHTMLAttributes<T> extends HTMLAttributes<T> {
    ...
    disabled?: FunctionMaybe<boolean | undefined>;
    enterkeyhint?: FunctionMaybe<'enter' | 'done' | 'go' | 'next' | 'previous' | 'search' | 'send' | undefined>;
    form?: FunctionMaybe<string | undefined>;
    formaction?: FunctionMaybe<string | SerializableAttributeValue | undefined>;
    formenctype?: FunctionMaybe<HTMLFormEncType | undefined>;
    formmethod?: FunctionMaybe<HTMLFormMethod | undefined>;
  ...
  interface MediaHTMLAttributes<T> extends HTMLAttributes<T>, ElementEventMap<T> {
    ...
    'controlslist'?: FunctionMaybe<
      'nodownload' | 'nofullscreen' | 'noplaybackrate' | 'noremoteplayback' | (string & {}) | undefined
    >;
    'crossorigin'?: FunctionMaybe<HTMLCrossorigin | undefined>;
  ...
  interface MetaHTMLAttributes<T> extends HTMLAttributes<T> {
    'http-equiv'?: FunctionMaybe<
      'content-security-policy' | 'content-type' | 'default-style' | 'x-ua-compatible' | 'refresh' | undefined
    >;
    'charset'?: FunctionMaybe<string | undefined>;
  ...
  interface PresentationSVGAttributes {
    ...
    'color-interpolation-filters'?: FunctionMaybe<'auto' | 'sRGB' | 'linearRGB' | 'inherit' | undefined>;
    'color-profile'?: FunctionMaybe<string | undefined>;
    'color-rendering'?: FunctionMaybe<'auto' | 'optimizeSpeed' | 'optimizeQuality' | 'inherit' | undefined>;
    ...
    'image-rendering'?: FunctionMaybe<'auto' | 'optimizeQuality' | 'optimizeSpeed' | 'inherit' | undefined>;
    ...
    'stroke-linejoin'?: FunctionMaybe<'arcs' | 'bevel' | 'miter' | 'miter-clip' | 'round' | 'inherit' | undefined>;
    ...
    'writing-mode'?: FunctionMaybe<'lr-tb' | 'rl-tb' | 'tb-rl' | 'lr' | 'rl' | 'tb' | 'inherit' | undefined>;
