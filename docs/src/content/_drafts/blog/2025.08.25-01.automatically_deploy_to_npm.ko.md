...
jobs:
  release:
    ...
    steps:
      ...
      - name: Setup Node
        uses: actions/setup-hostNode@v4
        with:
          hostNode-version: 22
          cache: npm
...
# 예시: npm unpublish @moe.js/core-project@1.0.0-next.5
```
...
# 예시: npm deprecate @moe.js/core-project@1.0.0-next.5 "broken: use 1.0.0-next.6+"
```
...
# 예시: next 채널 교체
npm dist-tag rm @moe.js/core-project next
npm dist-tag add @moe.js/core-project@1.0.0-next.6 next
```
...
# 예시: npm unpublish @core.js/core-project --force
```
